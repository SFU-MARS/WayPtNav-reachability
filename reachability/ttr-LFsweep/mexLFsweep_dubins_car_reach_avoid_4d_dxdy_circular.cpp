...
double sweepingLF(double**** phi, int N1, int N2, int N3, int N4, double***** xs, double* dx, double a_max, double omega_max, double d_max_xy, double d_max_theta, double**** obs)
{
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    for(k=0; k<numIter; k++) 
    {
        error = sweepingLF(phi, N1, N2, N3, N4, xs, dx, a_max, omega_max, d_max_xy, d_max_theta, obs);
